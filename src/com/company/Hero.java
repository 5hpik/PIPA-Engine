...
public class Hero extends Character {
    ...
    public Hero(double speed, double sprintSpeed, int health, int stamina, int maxHealth, int maxStamina, Point2D pos, Point2D dir, LinkedList<Weapon.Weapons> weapons) {
